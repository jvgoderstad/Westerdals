...
echo '
	<form method="POST" action="registrer_aktivitet.php">
		<div class="boxReg" id="largeBoxReg">
			...
			<label>
				<span>Navn</span>
				<input type="text" class="input_text" name="" autofocus required="" maxlength="50" title="Mellom 1-50 tegn langt."/>
			</label>
			<label>
				<span>Start dato</span>
				<input type="datetime" class="input_text" name="" required="" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))\s?(0[0-9]|1[0-9]|2[0-3])(:[0-5][0-9]){1}" title="YYYY-MM-DD HH:MM"/>
			</label>
			<label>
			...
			<label>
				...
				<input type="text" class="input_text" name="" maxlength="80" required="" title="Mellom 1-80 tegn langt."/>
			</label>
			<label>
				<span>Lang Beskrivelse</span>
				<textarea rows="15" cols="200" name="" required="" maxlength="5000" class="input_text" id="large_input_field" title="Mellom 1-80 tegn langt."></textarea>
			</label>
			<label align="center">
