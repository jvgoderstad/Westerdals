...
<div class ="formholder">
		...
		<div class="boxReg">
			...
			<label>
				<span>Fornavn</span>
				<input type="text" class="input_text" name="fornavn" required="" maxlength="45"/>
			</label>
			<label>
				<span>Etternavn</span>
				<input type="text" class="input_text" name="etternavn" required="" maxlength="60"/>
			</label>
			<label>
				<span>Studentnr</span>
				<input type="text" class="input_text" name="studentnummer" required="" maxlength="6"/>
			</label>
			<label>
				<span>Brukernavn</span>
				<input type="text" class="input_text" name="brukernavn" required="" maxlength="15"/>
			</label>
			<label>
				<span>E-post</span>
				<input type="email" class="input_text" name="email_1" required="" maxlength="60""/>
				<span>Gjenta</span>
				<input type="email" class="input_text" name="email_2" id="emailForm" id="email required="" maxlength="60""/>
			</label>
			<label>
				<span>Passord</span>
